...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1bz8gjx");
    			toggle_class(input, "sDirection", /*sDirection*/ ctx[0]);
    			add_location(input, file$2, 38, 1, 1109);
    			attr_dev(div, "class", "thread svelte-1bz8gjx");
    			attr_dev(div, "style", /*cssVarStyles*/ ctx[2]);
    			add_location(div, file$2, 37, 0, 1039);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*styles*/ ctx[1]['bg']);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", /*input_input_handler*/ ctx[9]),
    					listen_dev(input, "click", stop_propagation(/*click_handler*/ ctx[8]), false, false, true),
    					listen_dev(input, "change", /*setColor*/ ctx[4], false, false, false),
    					listen_dev(div, "click", /*toggleDirection*/ ctx[3], false, false, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { tablet } = $$props;
    	let { hole } = $$props;
    	let { bgColor = generateRandomColor() } = $$props;
    	let { sDirection = true } = $$props;
    	let styles = { 'bg': bgColor };

    	function toggleDirection() {
    		$$invalidate(0, sDirection = !sDirection);
    		dispatch('updateThread', { tablet, hole, bgColor, sDirection });
    	}
    	...
    	const writable_props = ['tablet', 'hole', 'bgColor', 'sDirection'];
    	...
    	$$self.$$set = $$props => {
    		if ('tablet' in $$props) $$invalidate(5, tablet = $$props.tablet);
    		if ('hole' in $$props) $$invalidate(6, hole = $$props.hole);
    		if ('bgColor' in $$props) $$invalidate(7, bgColor = $$props.bgColor);
    		if ('sDirection' in $$props) $$invalidate(0, sDirection = $$props.sDirection);
    	};
    ...
    class Thread extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*tablet*/ ctx[5] === undefined && !('tablet' in props)) {
    			console.warn("<Thread> was created without expected prop 'tablet'");
    		}

    		if (/*hole*/ ctx[6] === undefined && !('hole' in props)) {
    			console.warn("<Thread> was created without expected prop 'hole'");
    		}
    	}
    ...
    const file$1 = "src/components/Tablet.svelte";
    ...
    // (7:1) {#each holes as hole, index (index)}
    function create_each_block$1(key_1, ctx) {
    	...
    	thread.$on("updateThread", /*updateThread_handler*/ ctx[2]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*id*/ 1) thread_changes.tablet = /*id*/ ctx[0];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(7:1) {#each holes as hole, index (index)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "tablet svelte-1keum1o");
    			add_location(div, file$1, 5, 0, 108);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function updateThread_handler(event) {
    		bubble.call(this, $$self, event);
    	}
    	...
    	$$self.$capture_state = () => ({ Thread, id, holes });

    	$$self.$inject_state = $$props => {
    		if ('id' in $$props) $$invalidate(0, id = $$props.id);
    		if ('holes' in $$props) $$invalidate(1, holes = $$props.holes);
    	};
    	...
    	return [id, holes, updateThread_handler];
    }
    ...
    class Tablet extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*id*/ ctx[0] === undefined && !('id' in props)) {
    			console.warn("<Tablet> was created without expected prop 'id'");
    		}
    	}
    ...
    // (19:1) {#each tablets as tablet, index (index)}
    function create_each_block(key_1, ctx) {
    	...
    	tablet = new Tablet({
    			props: { id: /*index*/ ctx[5] },
    			$$inline: true
    		});

    	tablet.$on("updateThread", updateThread);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*tablets*/ 1) tablet_changes.id = /*index*/ ctx[5];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(19:1) {#each tablets as tablet, index (index)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 16, 15, 340);
    			add_location(button1, file, 16, 55, 380);
    			add_location(p, file, 16, 1, 326);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*addTablet*/ ctx[1], false, false, false),
    					listen_dev(button1, "click", /*removeTablet*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*tablets, updateThread*/ 1) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function addTablet(event) {
    		tablets.push(tablets.length + 1);
    		$$invalidate(0, tablets);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('tablets' in $$props) $$invalidate(0, tablets = $$props.tablets);
    	};
    	...
    	$$invalidate(0, tablets = []);
    	return [tablets, addTablet, removeTablet];
    }
